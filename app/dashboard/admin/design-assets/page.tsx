...
function VariantPreview({ id }: { id: string }) {
  ...
  const diagrams: Record<string, React.ReactNode> = {
    ...
    "hero-personal-billboard": (
      <svg viewBox="0 0 80 48" className="w-full h-full"><circle cx="20" cy="20" r="13" fill="currentColor" opacity=".22"/><circle cx="16" cy="16" r="4.5" fill="currentColor" opacity=".32"/><rect x="14" y="24" width="12" height="6" rx="3" fill="currentColor" opacity=".2"/><rect x="40" y="8" width="34" height="6" rx="1" fill="currentColor" opacity=".35"/><rect x="40" y="17" width="28" height="3.5" rx="1" fill="currentColor" opacity=".2"/><rect x="40" y="23" width="30" height="3" rx="1" fill="currentColor" opacity=".15"/><rect x="40" y="30" width="16" height="6" rx="2" fill="currentColor" opacity=".3"/><rect x="58" y="30" width="12" height="6" rx="2" fill="currentColor" opacity=".12"/></svg>
    ),
    "hero-portrait-showcase": (
      <svg viewBox="0 0 80 48" className="w-full h-full"><rect x="4" y="2" width="30" height="44" rx="3" fill="currentColor" opacity=".16"/><rect x="9" y="8" width="20" height="16" rx="2" fill="currentColor" opacity=".28"/><circle cx="15" cy="13" r="2.5" fill="currentColor" opacity=".4"/><rect x="9" y="29" width="14" height="3" rx="1" fill="currentColor" opacity=".2"/><rect x="9" y="35" width="18" height="3" rx="1" fill="currentColor" opacity=".14"/><rect x="38" y="10" width="36" height="6" rx="1" fill="currentColor" opacity=".35"/><rect x="38" y="19" width="20" height="4" rx="2" fill="currentColor" opacity=".25"/><rect x="38" y="26" width="30" height="3.5" rx="1" fill="currentColor" opacity=".18"/><rect x="38" y="32" width="14" height="6" rx="2" fill="currentColor" opacity=".3"/><rect x="54" y="32" width="14" height="6" rx="2" fill="currentColor" opacity=".12"/></svg>
    ),
    "hero-work-preview-strip": (
      <svg viewBox="0 0 80 48" className="w-full h-full"><rect x="6" y="5" width="40" height="6" rx="1" fill="currentColor" opacity=".3"/><rect x="6" y="14" width="30" height="3" rx="1" fill="currentColor" opacity=".18"/>{[6,30,54].map(x=><g key={x}><rect x={x} y={22} width="22" height="14" rx="2" fill="currentColor" opacity=".2"/><rect x={x+2} y={25} width="12" height="5" rx="1" fill="currentColor" opacity=".3"/><rect x={x+2} y={32} width="14" height="2.5" rx="1" fill="currentColor" opacity=".14"/></g>)}</svg>
    ),
    "hero-chronology-badge": (
      <svg viewBox="0 0 80 48" className="w-full h-full"><rect x="6" y="6" width="22" height="6" rx="3" fill="currentColor" opacity=".28"/><rect x="6" y="15" width="44" height="6" rx="1" fill="currentColor" opacity=".35"/>{[24,31,38].map(y=><g key={y}><circle cx="9" cy={y} r="1.8" fill="currentColor" opacity=".4"/><rect x="14" y={y-1.5} width="30" height="3" rx="1" fill="currentColor" opacity=".16"/></g>)}<rect x="52" y="8" width="24" height="32" rx="2" fill="currentColor" opacity=".15"/><rect x="56" y="13" width="16" height="3.5" rx="1" fill="currentColor" opacity=".25"/><rect x="56" y="19" width="12" height="3" rx="1" fill="currentColor" opacity=".15"/><rect x="56" y="26" width="16" height="4" rx="2" fill="currentColor" opacity=".22"/><rect x="56" y="33" width="8" height="3" rx="1" fill="currentColor" opacity=".12"/></svg>
    ),

    // Hero effects (6)
    "hero-effect-modern-grid": (
      <svg viewBox="0 0 80 48" className="w-full h-full"><rect x="2" y="2" width="76" height="44" rx="3" fill="currentColor" opacity=".16"/><path d="M42 8h24M42 14h24M42 20h24M42 26h24M42 32h24M42 38h24M46 6v34M54 6v34M62 6v34" stroke="currentColor" strokeWidth=".7" strokeOpacity=".12"/><rect x="46" y="8" width="20" height="12" rx="1" fill="currentColor" opacity=".16"/><rect x="10" y="12" width="26" height="6" rx="1" fill="currentColor" opacity=".32"/><rect x="10" y="21" width="20" height="3" rx="1" fill="currentColor" opacity=".18"/><rect x="10" y="28" width="14" height="5" rx="1" fill="currentColor" opacity=".25"/></svg>
    ),
    "hero-effect-glassmorphism": (
      <svg viewBox="0 0 80 48" className="w-full h-full"><rect x="2" y="2" width="76" height="44" rx="3" fill="currentColor" opacity=".18"/><circle cx="66" cy="16" r="9" fill="currentColor" opacity=".2"/><circle cx="60" cy="34" r="5" fill="currentColor" opacity=".12"/><rect x="8" y="10" width="42" height="28" rx="3" fill="currentColor" opacity=".1" stroke="currentColor" strokeWidth=".6" strokeOpacity=".22"/><rect x="12" y="16" width="26" height="5" rx="1" fill="currentColor" opacity=".3"/><rect x="12" y="24" width="20" height="3" rx="1" fill="currentColor" opacity=".18"/><rect x="12" y="30" width="16" height="4" rx="1" fill="currentColor" opacity=".22"/></svg>
    ),
    "hero-effect-neobrutalism": (
      <svg viewBox="0 0 80 48" className="w-full h-full"><rect x="4" y="5" width="38" height="20" rx="1" fill="currentColor" opacity=".25" stroke="currentColor" strokeWidth="1.5" strokeOpacity=".45"/><rect x="8" y="9" width="30" height="5" rx="1" fill="currentColor" opacity=".4"/><rect x="8" y="17" width="14" height="5" rx="1" fill="currentColor" opacity=".3"/><rect x="46" y="10" width="30" height="30" rx="1" fill="currentColor" opacity=".16" stroke="currentColor" strokeWidth="1.5" strokeOpacity=".45"/><rect x="50" y="18" width="22" height="6" rx="1" fill="currentColor" opacity=".4"/><rect x="50" y="28" width="10" height="3" rx="1" fill="currentColor" opacity=".2"/></svg>
    ),
    "hero-effect-scanlines": (
      <svg viewBox="0 0 80 48" className="w-full h-full">{[7,11,15,19,23,27,31,35,39].map(y=><rect key={y} x="4" y={y} width="72" height=".7" fill="currentColor" opacity=".16"/>)}<rect x="10" y="12" width="34" height="6" rx="1" fill="currentColor" opacity=".4"/><rect x="10" y="21" width="26" height="3" rx="1" fill="currentColor" opacity=".25"/><rect x="10" y="27" width="16" height="7" rx="2" fill="currentColor" opacity=".35"/></svg>
    ),
    "hero-effect-starfield": (
      <svg viewBox="0 0 80 48" className="w-full h-full"><rect x="2" y="2" width="76" height="44" rx="3" fill="currentColor" opacity=".2"/>{[[10,30],[16,36],[26,34],[44,40],[52,36],[62,40],[70,34],[68,12],[12,10],[30,9],[58,8],[36,14],[24,8]].map((d,i)=><circle key={i} cx={d[0]} cy={d[1]} r="1" fill="currentColor" opacity={i%2? ".25":".4"}/>)}<rect x="14" y="12" width="36" height="6" rx="1" fill="currentColor" opacity=".45"/><rect x="14" y="21" width="24" height="3" rx="1" fill="currentColor" opacity=".3"/><rect x="14" y="28" width="28" height="8" rx="2" fill="currentColor" opacity=".35"/></svg>
    ),
    "hero-effect-retro-paper": (
      <svg viewBox="0 0 80 48" className="w-full h-full"><g transform="rotate(-1.5 40 24)"><rect x="2" y="2" width="76" height="44" rx="2" fill="currentColor" opacity=".14"/>{[14,24,38,52,62,22,58,40].map((x,i)=><circle key={i} cx={x} cy={[10,18,34,26,14,38,30,8][i]} r="1" fill="currentColor" opacity=".22"/>)}<rect x="14" y="14" width="36" height="6" rx="1" fill="currentColor" opacity=".38"/><rect x="14" y="23" width="26" height="3" rx="1" fill="currentColor" opacity=".22"/><rect x="14" y="29" width="18" height="8" rx="2" fill="currentColor" opacity=".3"/></g></svg>
    ),
