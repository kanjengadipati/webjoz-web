  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-3 gap-3">
        <Button variant="outline" onClick={handleGoogleClick} className="w-full rounded-xl border-border/60 bg-background/50 py-6 hover:bg-primary/5 transition-all duration-300 group">
        ...
        <Button variant="outline" onClick={handleFacebookClick} className="w-full rounded-xl border-border/60 bg-background/50 py-6 hover:bg-[#1877F2]/5 transition-all duration-300 group">
        ...
        <Button variant="outline" disabled className="w-full rounded-xl border-border/60 bg-background/50 py-6 opacity-30 cursor-not-allowed grayscale">
