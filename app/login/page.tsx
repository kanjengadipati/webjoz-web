      ...
      {hasAnySocial && (
        <>
          ...
          <div className="grid grid-cols-2 gap-2 sm:gap-3">
            {hasGoogle && (
              <Button variant="outline" onClick={handleGoogleClick} aria-label="Continue with Google" className="w-full rounded-xl border-border/60 bg-background/50 py-5 sm:py-6 hover:bg-primary/5 transition-all duration-300 group">
            ...
            {hasFacebook && (
              <Button variant="outline" onClick={handleFacebookClick} aria-label="Continue with Facebook" className="w-full rounded-xl border-border/60 bg-background/50 py-5 sm:py-6 hover:bg-[#1877F2]/5 transition-all duration-300 group">
