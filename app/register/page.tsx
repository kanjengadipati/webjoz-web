  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-3 gap-2 sm:gap-3">
        <Button variant="outline" className="w-full rounded-xl py-5 sm:py-6 hover:bg-primary/5 transition-all duration-300 group">
        ...
        <Button variant="outline" disabled className="w-full rounded-xl py-5 sm:py-6 opacity-30 cursor-not-allowed grayscale">
