...
export default function RegisterPage() {
  ...
  return (
    ...
    >
      ...
      {SOCIAL_ACTIVE_PROVIDERS.length > 0 && (
        <>
          ...
          <div className="grid grid-cols-2 gap-2 sm:gap-3">
            {SOCIAL_ACTIVE_PROVIDERS.includes("google") && (
              <Button variant="outline" disabled className="w-full rounded-xl py-5 sm:py-6 opacity-50 cursor-not-allowed grayscale group">
            ...
            {SOCIAL_ACTIVE_PROVIDERS.includes("facebook") && (
              <Button variant="outline" disabled className="w-full rounded-xl py-5 sm:py-6 opacity-50 cursor-not-allowed grayscale group">
