          ...
          <div className="space-y-4">
                  ...
                  {links.map((link, i) => {
                    ...
                    return (
                      <a
                        ...
                        className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-[var(--dt-radius)] border border-white/10 bg-white/[0.03] transition-all hover:bg-white/[0.08] hover:border-white/20"
            ...
            <div>
              <button
                type="button"
                onClick={scrollToTop}
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full border border-white/15 bg-white/[0.04] text-[11px] font-medium transition-all hover:bg-white/[0.1] hover:border-white/30 cursor-pointer"
                style={{ color: TXT_HIGH }}
              >
