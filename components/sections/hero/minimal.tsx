...
export default function HeroMinimal({ hero, design_token }: HeroVariantProps) {
  return (
    <section style={{ position: "relative", minHeight: "60vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "5rem 1.5rem", background: "var(--dt-bg)", overflow: "hidden" }}>
