...
export default function HeroSplit({ hero, design_token }: HeroVariantProps) {
  return (
    <section style={{ position: "relative", minHeight: "85vh", display: "flex", alignItems: "center", justifyContent: "flex-start", padding: "5rem 1.5rem", background: "var(--dt-bg)", overflow: "hidden" }}>
