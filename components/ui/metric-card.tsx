...
export function MetricCard({
  ...
  return (
    <Card className={cn("relative overflow-hidden group shadow-md shadow-slate-900/10 hover:shadow-slate-900/15 dark:shadow-sm dark:hover:shadow-primary/5", MOTION.slow, style.ring)}>
      ...
      <CardHeader className="space-y-4 p-6">
        ...
        {helper ? <div className="line-clamp-2 text-xs font-medium leading-relaxed text-muted-foreground/85 dark:text-muted-foreground/60">{helper}</div> : null}
      </CardHeader>
    </Card>
  );
}
