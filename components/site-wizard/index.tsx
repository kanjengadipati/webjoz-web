        ...
        {visibleChips.map((st) => {
          ...
          return (
            ...
            >
              ...
              <span className={`transition-all duration-200 text-left ${isSelected ? "max-w-none" : "max-w-[95px] sm:max-w-[110px] truncate hover:max-w-none"}`}>
                {labelText}
              </span>
                    ...
                    {subTypes.map((st) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <span className={`transition-all duration-200 text-left ${isSubSelected ? "max-w-none" : "max-w-[95px] sm:max-w-[110px] truncate hover:max-w-none"}`}>
                            {labelText}
                          </span>
