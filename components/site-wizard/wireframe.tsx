      ...
      <div className="w-full max-w-xl lg:max-w-3xl mx-auto space-y-6 sm:space-y-8 relative z-10">
        ...
        >
          <div className="flex items-center gap-2 min-w-0">
            {businessName ? (
              ...
              <div className="h-7 w-24 sm:w-28 rounded-lg" style={skeletonStrong} />
            )}
          </div>
            ...
            {businessType ? (
              ...
              <div className="hidden sm:flex gap-2 items-center">
                {WIREFRAME_STEPS.map((_, i) => (
                  <div key={i} className="h-4 w-14 rounded-md" style={skeletonSoft} />
                ))}
              </div>
            )}
            <div className="h-7 sm:h-8 w-16 sm:w-24 rounded-lg shrink-0" style={skeletonStrong} />
          </div>
        </header>
        ...
        >
          <div className="relative z-10 flex flex-col justify-center p-6 sm:p-12 gap-3.5 sm:gap-4.5">
            {businessType ? (
              ...
              <div className="h-5 w-24 rounded-full" style={skeletonStrong} />
            )}
            ...
            <div className="space-y-2.5">
              {businessName ? (
                ...
                <div className="h-10 w-3/4 rounded-xl" style={skeletonStrong} />
              )}
              {description ? (
                <div
                ...
                <div className="h-6 w-1/2 rounded-lg" style={skeletonSoft} />
              )}
            </div>

            <div className="h-4 w-2/3 rounded-md" style={skeletonSoft} />
            ...
            >
              {highlight ? "Pesan Sekarang →" : <div className="h-full w-full rounded-xl" style={skeletonStrong} />}
            </div>
          </div>
        ...
        <section className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
          {[0, 1, 2, 3].map((i) => (
            ...
            >
              <div className="w-9 h-9 rounded-xl" style={skeletonStrong} />
              <div className="h-3.5 w-3/4 rounded-md" style={skeletonStrong} />
              <div className="h-2.5 w-full rounded-md" style={skeletonSoft} />
              <div className="h-2.5 w-2/3 rounded-md" style={skeletonSoft} />
            </div>
          ))}
        </section>
        ...
        >
          <div className="flex-1 w-full space-y-3.5">
            <div className="h-6 w-2/3 rounded-lg" style={skeletonStrong} />
            <div className="h-3 w-full rounded-md" style={skeletonSoft} />
            <div className="h-3 w-5/6 rounded-md" style={skeletonSoft} />
            <div className="h-3 w-4/6 rounded-md" style={skeletonSoft} />
          </div>
          <div className="w-full sm:w-36 h-32 sm:h-36 rounded-2xl shrink-0" style={skeletonStrong} />
        </section>
