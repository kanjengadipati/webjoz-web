...
export const BUSINESS_TYPES: BusinessTypeItem[] = [
  ...
  { value: "Layanan & Reservasi", emoji: "📅", label: "Layanan & Reservasi", desc: "Salon, Bengkel, Klinik, dll" },
...
export const NAME_TYPE_HINTS: Record<string, { type?: string; subType?: string }> = {
  ...
  "fotogra": { type: "Kreatif & Profesional", subType: "Fotografer" }, // partial to catch fotografer/photographer
