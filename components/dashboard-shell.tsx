            ...
            <header className="sticky top-0 z-20 rounded-3xl border border-border/80 bg-card/90 px-6 py-4 backdrop-blur-xl shadow-lg shadow-slate-900/10 dark:border-border/40 dark:bg-background/60 dark:shadow-black/5">
              <div className="flex flex-wrap items-center justify-between gap-4">
                ...
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  {/* WhatsApp Support Header Button */}
                  <a
                    href={getWhatsAppUrl("Halo CS Webjoz, saya butuh bantuan di dashboard.")}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-1.5 rounded-full border border-emerald-500/30 bg-emerald-500/10 hover:bg-emerald-500/20 px-3 py-1.5 text-xs font-semibold text-emerald-400 transition-all hover:border-emerald-500/50 shadow-sm"
                    title="Bantuan WhatsApp CS"
                  >
