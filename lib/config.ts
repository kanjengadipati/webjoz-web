 ...
 */
export const TOKEN_STORAGE_KEY = "webjoz_access_token";
export const REFRESH_STORAGE_KEY = "webjoz_refresh_token";
export const EMAIL_STORAGE_KEY = "webjoz_email";
export const THEME_STORAGE_KEY = "webjoz_theme";
export const ACCENT_STORAGE_KEY = "webjoz_accent";
