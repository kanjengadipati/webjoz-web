  ...
  id: {
    ...
    dashboard: {
      ...
      wizard: {
        ...
        websiteReady: "🎉 Website Anda siap! Pratinjau tersedia di sebelah kanan. Gunakan tombol Edit untuk kustomisasi konten, lalu klik Publish untuk mempublikasikan website Anda.",
  ...
  en: {
    ...
    dashboard: {
      ...
      wizard: {
        ...
        websiteReady: "🎉 Your website is ready! Preview is on the right. Use the Edit button to customize content, then click Publish to go live.",
