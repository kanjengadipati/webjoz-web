...
export const translations: Record<Locale, Translations> = {
  id: {
    landing: {
      ...
      heroTitle: 'Generate website <br className="lg:hidden" />instan. <span class="inline-block text-white">✧</span><br /><span class="inline-block text-[0.6em] sm:text-[0.68em] lg:text-[0.62em] font-extrabold tracking-tight bg-white text-black px-3.5 py-1 sm:px-5 sm:py-1.5 rounded-none mt-2 sm:mt-2.5 shadow-lg">Custom tanpa batas.</span>',
    ...
    dashboard: {
      ...
      wizard: {
        ...
        categories: {
          ...
          portofolioKreatorDesc: "Developer, Desainer, Agency, dll",
  ...
  en: {
    landing: {
      ...
      heroTitle: 'Generate websites <br className="lg:hidden" />instantly. <span class="inline-block text-white">✧</span><br /><span class="inline-block text-[0.58em] sm:text-[0.66em] lg:text-[0.6em] font-extrabold tracking-tight bg-white text-black px-3.5 py-1 sm:px-5 sm:py-1.5 rounded-none mt-2 sm:mt-2.5 shadow-lg">Unlimited customization.</span>',
    ...
    dashboard: {
      ...
      wizard: {
        ...
        categories: {
          ...
          portofolioKreatorDesc: "Developers, Designers, Agencies, etc",
          company: "Company Profile",
