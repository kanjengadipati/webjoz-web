export const DASHBOARD_NAVIGATION = [
  ...
  { id: "orders", href: "/dashboard/orders", label: "Pesanan", permission: "lead:read", icon: "shopping-bag", section: "Website Builder", groupStart: false },
  ...
  { id: "sales-referral", href: "/dashboard/sales", label: "Ajak Teman & Referral", permission: "", icon: "share", section: "Sales & Referral", groupStart: false },
  { id: "sales-commissions", href: "/dashboard/sales/commissions", label: "Komisi Saya", permission: "", icon: "dollar", section: "Sales & Referral", groupStart: false },
