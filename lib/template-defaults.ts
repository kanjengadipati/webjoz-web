...
export const TEMPLATE_DEFAULT_DESIGN_TOKENS: Record<string, DesignToken> = {
    ...
    TEMPLATE_JASA02: {
        ...
        layout: {
            ...
            corner_radius: "soft",
            section_spacing: "normal",
            section_order: ["hero", "about", "catalog", "benefits", "testimonials", "gallery", "cta", "faq", "contact"],
        },
        mood: "professional",
        theme_mode: "light",
    },
    ...
    TEMPLATE_ELEGANT: {
        ...
        layout: {
            ...
            section_order: ["hero", "about", "catalog", "testimonials", "benefits", "cta", "contact"],
        },
        mood: "dark-premium",
        theme_mode: "dark",
    },
    TEMPLATE_NATURAL: {
        ...
        layout: {
            ...
            corner_radius: "rounded",
            section_spacing: "relaxed",
            section_order: ["hero", "about", "catalog", "benefits", "testimonials", "cta", "faq", "contact"],
        },
        mood: "warm-earthy",
        theme_mode: "light",
    },
    TEMPLATE_COLORFUL: {
        ...
        layout: {
            ...
            corner_radius: "rounded",
            section_spacing: "normal",
            section_order: ["hero", "catalog", "benefits", "about", "testimonials", "cta", "contact"],
        },
        mood: "bold-vibrant",
        theme_mode: "light",
    },
    TEMPLATE_MINIMALIST: {
        ...
        layout: {
            ...
            corner_radius: "sharp",
            section_spacing: "relaxed",
            section_order: ["hero", "about", "catalog", "benefits", "cta", "testimonials", "contact"],
        },
        mood: "clean-modern",
        theme_mode: "light",
    },
    ...
    TEMPLATE_RETRO: {
        ...
        layout: {
            ...
            corner_radius: "rounded",
            section_spacing: "normal",
            section_order: ["hero", "about", "catalog", "testimonials", "benefits", "faq", "cta", "contact"],
        },
        mood: "retro",
        theme_mode: "dark",
    },
